...
//
// SetTaskSlabSize's job, like SetFiberBudget's, is to change what TaskScheduler's construction
...
int main() {
    ...
    Check(JLib::TaskScheduler::TaskSlabSize() == 1024 * 1024, "default slab size is 1024*1024");
    ...
    JLib::TaskScheduler::SetTaskSlabSize(kSlots);
    Check(JLib::TaskScheduler::TaskSlabSize() == kSlots, "getter reflects the new value");
